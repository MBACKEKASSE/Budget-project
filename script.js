...
function getExpense() {
  return JSON.parse(localStorage.getItem("initialExpenses"));
}

function getIncomes() {
  return JSON.parse(localStorage.getItem("initialIncomes"));
}
...
myForm.addEventListener("submit", function (e) {
  ...
  balanceAmount.innerHTML = expenseAmount.innerHTML - budgetAmount.innerHTML;
});
